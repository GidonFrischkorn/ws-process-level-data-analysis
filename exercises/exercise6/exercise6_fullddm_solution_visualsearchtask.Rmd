...
Your task is to load one of the data sets we prepared for this exercise, `excercise5_visual_search_task.txt` or `excercise5_color_judgement_task.txt`.
...
```{r aggregate data}
ddm_data <- read.table(here("data","exercise5_visual_search_task.txt"),
                        header = T)
...
ddm_fit <- bmm(
  ...
  sample_prior = TRUE,
  backend = "cmdstanr",
  file = here("models","ddm_visualsearch_exc6")
)
```
