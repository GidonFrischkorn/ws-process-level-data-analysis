...
Now, we can consider which parameters are affected by the experimental manipulations. Here we assume different `drift` and `ndt` dependent on the the type of cue (positive/negative/neutral). Apart from that I only include fixed and random intercepts for the boundary and relative starting point.
...
```{r ddm_hypothesis}
ddm_hypothesis <- c(
  drift_neg_neu = "drift_conditionnegative - drift_conditionneutral = 0",
  drift_neu_pos = "drift_conditionneutral - drift_conditionpositive = 0",
  drift_neg_pos = "drift_conditionnegative - drift_conditionpositive = 0",
  bias = "zr_Intercept = 0",
  ndt_neg_neu   = "ndt_conditionnegative - ndt_conditionneutral = 0",
  ndt_neu_pos   = "ndt_conditionneutral - ndt_conditionpositive = 0",
  ndt_neg_pos   = "ndt_conditionnegative - ndt_conditionpositive = 0",
)
