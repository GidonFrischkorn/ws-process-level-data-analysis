...
# draw subject parameters: for the simple choice rule, i used a log link function
# to ensure that activation parameters are positive
...
m3_fit_custom <- bmm(
  ...
  cores = 4,
  refresh = 0,
  file = here("models","parRec_m3_exc5")
)
